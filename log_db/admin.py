...
class StatusLogAdmin(admin.ModelAdmin):
    list_display = ('create_datetime_format', 'user', 'application', 'traceback', 'colored_msg')
    list_display_links = ('colored_msg',)
    list_filter = ('level', 'create_datetime', 'application')
    search_fields = ('user', 'create_datetime')
    list_per_page = 1000
